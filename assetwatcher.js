...
(function() {
  var args, captureImports, commandToExecute, dirs, exec, execDelay, execHistory, executeCommandFor, fireworm, fs, help, ignore, importHistory, imports, onlyExt, options, path, processFile, processFileAdded, regEx, runNow, silent, startExecutionFor, startTime, yargs;
  ...
  processFileAdded = function(filePath) {
    return processFile(filePath, 'added');
  };

  processFile = function(filePath, eventType) {
    if (eventType == null) {
      eventType = 'changed';
    }
    ...
    return fs.stat(filePath, function(err, stats) {
      ...
      if (stats.isFile()) {
        return fs.readFile(filePath, 'utf8', function(err, data) {
          ...
          return startExecutionFor(filePath, eventType);
        });
      }
    });
  };
  ...
  startExecutionFor = function(filePath, eventType) {
    var importingFiles;
    if (importHistory[filePath] != null) {
      ...
      return executeCommandFor(filePath, eventType);
    }
  };

  executeCommandFor = function(filePath, eventType) {
